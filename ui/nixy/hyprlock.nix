# hyprlock ported from anotherhadi/nixy (home/system/hyprlock/default.nix) —
# the box-drawing ASCII lock screen. stylix colours/font replaced by the theme.
{ config, lib, pkgs, ... }:
let
  t = import ./theme.nix;
  c = t.colors;
  font = t.fonts.monospace;
