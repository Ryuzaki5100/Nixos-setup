# hyprlock ported from Frost-Phoenix/nixos-config
# (modules/home/hyprland/hyprlock.nix); wallpaper via the shared module.
{ pkgs, lib, ... }:
let
  inherit (import ../shared/wallpapers.nix { inherit pkgs lib; }) frost-hyprlock;
in
{
  programs.hyprlock = {
    enable = true;
