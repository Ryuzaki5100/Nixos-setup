# Ghostty ported from Frost-Phoenix/nixos-config
# (modules/home/ghostty/ghostty.nix). The laptop font-size branch is dropped.
{ ... }:
{
  programs.ghostty = {
    enable = true;
  ...
  xdg.configFile."ghostty/styles/tabs.css".source = ./ghostty-tabs.css;
}
